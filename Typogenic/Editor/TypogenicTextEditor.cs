...
public class TypogenicTextEditor : Editor
{
    ...
    protected SerializedProperty m_JustifiedStrict;
    ...
    void OnEnable()
    {
        ...
        m_JustifiedStrict = serializedObject.FindProperty("JustifiedStrict");
    ...
    public override void OnInspectorGUI()
    {
        ...
        /*
         *  Displays the options for justified text only when justified selected
         */
        if (m_Alignment.enumValueIndex == (int)TTextAlignment.Justified)
        {
            EditorGUILayout.PropertyField(m_JustifiedStrict);
        }
